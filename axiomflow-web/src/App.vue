  ...
  <div class="app-shell">
    <header class="app-header">
      <button
        class="logo"
        type="button"
        title="AxiomFlow - PDF 数学文档翻译与排版工具"
        @click="router.push('/')"
      >
      ...
      <nav class="nav-links" :class="{ 'nav-links-open': isNavOpen }">
        ...
        <RouterLink to="/app" class="nav-link-item">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        >
          ...
          <div v-if="showMenu" class="user-menu">
            ...
            <div class="user-menu-divider"></div>
            <button class="user-menu-item" @click="toggleLanguage">
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span>语言：{{ currentLanguageLabel }}</span>
            </button>
...
const currentThemeLabel = computed(() => (theme.value === "dark" ? "深色" : "浅色"));
const currentLanguageLabel = computed(() => (language.value === "zh-CN" ? "简体中文" : "English"));
...
const applyLanguage = (value: "zh-CN" | "en-US") => {
  language.value = value;
  localStorage.setItem("language", value);
  // 预留：未来可在此对接 i18n 切换逻辑
};

const toggleLanguage = () => {
  applyLanguage(language.value === "zh-CN" ? "en-US" : "zh-CN");
};
...
onMounted(() => {
  ...
  const storedLang = (localStorage.getItem("language") as "zh-CN" | "en-US" | null);
