import {
  __webpack_exports__AbortException,
  __webpack_exports__AnnotationEditorLayer,
  __webpack_exports__AnnotationEditorParamsType,
  __webpack_exports__AnnotationEditorType,
  __webpack_exports__AnnotationEditorUIManager,
  __webpack_exports__AnnotationLayer,
  __webpack_exports__AnnotationMode,
  __webpack_exports__ColorPicker,
  __webpack_exports__DOMSVGFactory,
  __webpack_exports__DrawLayer,
  __webpack_exports__FeatureTest,
  __webpack_exports__GlobalWorkerOptions,
  __webpack_exports__ImageKind,
  __webpack_exports__InvalidPDFException,
  __webpack_exports__MissingPDFException,
  __webpack_exports__OPS,
  __webpack_exports__OutputScale,
  __webpack_exports__PDFDataRangeTransport,
  __webpack_exports__PDFDateString,
  __webpack_exports__PDFWorker,
  __webpack_exports__PasswordResponses,
  __webpack_exports__PermissionFlag,
  __webpack_exports__PixelsPerInch,
  __webpack_exports__RenderingCancelledException,
  __webpack_exports__TextLayer,
  __webpack_exports__TouchManager,
  __webpack_exports__UnexpectedResponseException,
  __webpack_exports__Util,
  __webpack_exports__VerbosityLevel,
  __webpack_exports__XfaLayer,
  __webpack_exports__build,
  __webpack_exports__createValidAbsoluteUrl,
  __webpack_exports__fetchData,
  __webpack_exports__getDocument,
  __webpack_exports__getFilenameFromUrl,
  __webpack_exports__getPdfFilenameFromUrl,
  __webpack_exports__getXfaPageViewport,
  __webpack_exports__isDataScheme,
...
//# sourceMappingURL=pdfjs-dist_legacy_build_pdf__mjs.js.map
